// Behavioural checks for the 2.4.2 runtime tag: conversio_id minting and
...
//
// Usage: node test/runtime-tag-2.4.2.test.js
'use strict';
...
var TAG_PATHS = [
  { label: 'conversio_runtime_tag_v2.4.2.js', path: path.join(__dirname, '..', 'conversio_runtime_tag_v2.4.2.js') },
  { label: 'self-hosted/public/runtime-tag.2.4.2.js', path: path.join(__dirname, '..', 'self-hosted', 'public', 'runtime-tag.2.4.2.js') }
];
