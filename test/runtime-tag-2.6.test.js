// Behavioural checks for the 2.6 runtime tag: conversio_id minting and
...
var TAG_PATHS = [
  { label: 'conversio_runtime_tag_v2.6.js', path: path.join(__dirname, '..', 'conversio_runtime_tag_v2.6.js') },
  { label: 'self-hosted/public/runtime-tag.2.6.js', path: path.join(__dirname, '..', 'self-hosted', 'public', 'runtime-tag.2.6.js') }
];
