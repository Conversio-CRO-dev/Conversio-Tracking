// Behavioural checks for the 2.5 runtime tag: conversio_id minting and
...
// not have moved it.
//
// Usage: node test/runtime-tag-2.5.test.js
'use strict';
...
var TAG_PATHS = [
  { label: 'conversio_runtime_tag_v2.5.js', path: path.join(__dirname, '..', 'conversio_runtime_tag_v2.5.js') },
  { label: 'self-hosted/public/runtime-tag.2.5.js', path: path.join(__dirname, '..', 'self-hosted', 'public', 'runtime-tag.2.5.js') }
];
